    ...
    <!-- CONTROLLER -->
        <section class="controller">
            <ul class="flex space-between fx-align-center">
                ...
                <li @click="toggleSort" class="secondary-nav-item"><i class="fas fa-sort"></i> Sort</li>
                <li @click="toggleFilter" class="secondary-nav-item"><i class="fas fa-filter"></i> Filter</li>
                <li class="secondary-nav-item"><i class="fas fa-inbox"></i> <span>{{unReadEmails}}</span></li>
            </ul>
